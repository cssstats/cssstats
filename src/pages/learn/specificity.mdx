...
[OOCSS principles](http://www.smashingmagazine.com/2011/12/12/an-introduction-to-object-oriented-css-oocss)
or a [preprocessor](http://sass-lang.com) would be a great place to start. This allows
...
ID selectors have a _very_ high specificity value. This becomes especially problematic when you
...
makes specificity a mere hiccup during development. A class selector will _always_ have a
